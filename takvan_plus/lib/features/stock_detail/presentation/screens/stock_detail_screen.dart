      ...
      return Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('${(1000 * (i + 1))}', style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
          ],
        ),
      );
    });
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(l10n.codalReports, style: const TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                  ],
                ),
              ),
