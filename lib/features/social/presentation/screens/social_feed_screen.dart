                ...
                Wrap(
                  ...
                  children: SocialTagType.values.map((t) {
                    final label = switch (t) {
                      ...
                      SocialTagType.marketIndex => 'شاخص',
                    };
                    return ChoiceChip(
                      label: Text(label),
                      selected: tagType == t,
            ...
            Row(
              children: [
                InkWell(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.favorite_border, size: 15, color: AppColors.textMuted),
                      const SizedBox(width: 4),
                      Text('${post.likes}', style: TextStyle(fontSize: 11, color: AppColors.textMuted)),
                    ],
                  ),
                ),
              ],
