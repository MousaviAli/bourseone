                      ...
                      child: GlassCard(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(f.manager, style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('NAV هر واحد', style: TextStyle(fontSize: 10, color: AppColors.textMuted)),
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('بازده ۱ ساله', style: TextStyle(fontSize: 10, color: AppColors.textMuted)),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text('تغییر روزانه', style: TextStyle(fontSize: 10, color: AppColors.textMuted)),
